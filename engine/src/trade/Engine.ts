...
//Engine class has to maintain Orderbook Array
//Orderbook Array will have => bids[], asks[], market, currentPrice

export class Engine {
    private orderbooks: Orderbook[] = [];
    private balances: Map<string, UserBalance> = new Map();

    //Fetching data from existing snapshot
    //orderbook and balances data => user balance
    constructor() {
        let snapshot = null
        try {
            //@ts-ignore
    ...
    //Function to save snapshot and balances
    saveSnapshot() {
    ...
    //adding new orderbook i.e new market
    ...
    //Creating new order => 
    //Step 1. Find ticker, eg =>SOL_USDC
    //step 2. check if user has funds, if yes then lock it
    //step 3: add order in orderbook ....update user balance
    // step 4: update trade table
    //step 5 : update db orders
    //steo 6: update ws depth
    //step 7: update webspcket trade
    ...
    //sending trade data to redis, as new trade happened
    ...
    //update depth data and send it to redis to give confirmation to user
    ...
    //sending depth data to websocket
